...
def main(args):
  ...
  # load my model
  MODEL_NAME='./results/roberta_sch_cosine_with_restarts/checkpoint-30000' # model dir.
  ...
  submission.to_csv('./roberta_base_roberta_sch_cosine_with_restarts.csv',index=False)

if __name__ == '__main__':
  parser = argparse.ArgumentParser()
  
  # model dir
  parser.add_argument('--model_dir', type=str, default="./results/roberta_sch_cosine_with_restarts/checkpoint-30000")
